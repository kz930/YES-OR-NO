...
update questions set side_a_label = '愿意',   side_b_label = '不愿意' where title like '经验机器%';
...
update questions set side_a_label = '要',     side_b_label = '不要'   where title like '你能听到陌生人%' or title like '%陌生人%在心里想到你%';
